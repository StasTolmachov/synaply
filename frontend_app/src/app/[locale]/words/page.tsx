          ...
          <div className="p-4 border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/50">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-200 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-1 focus:ring-synaply-blue dark:focus:ring-synaply-cyan focus:border-synaply-blue dark:focus:border-synaply-cyan bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 transition-colors"
                value={search}
                          ...
                          {editingId === word.id ? (
                            ...
                            <div className="flex space-x-2">
                              <button
                                ...
                                className="px-2 py-1 text-synaply-blue dark:text-synaply-cyan hover:bg-synaply-blue/5 dark:hover:bg-synaply-cyan/10 rounded text-xs font-medium border border-synaply-blue/10 dark:border-synaply-cyan/20"
                              >
                                {t('common.edit')}
                              </button>
                              <button
