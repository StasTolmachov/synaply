...
1.**Произношение**: Напиши, как звучит слово "%[4]s", используя только буквы алфавита языка "%[1]s". Строго запрещено использовать международные знаки транскрипции. Обязательно выдели ударную гласную ЗАГЛАВНОЙ буквой.
